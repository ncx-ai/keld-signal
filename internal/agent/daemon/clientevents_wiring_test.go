...
func TestProcessEmitsWorkerPanicWithRedactedError(t *testing.T) {
	...
	process(context.Background(), j, enrichtest.NewFake(), nil, &fakeSender{}, "actor@keld.co", panicGate, emitter, nil, nil)
...
func TestProcessEmitsPublishFailedWithRedactedError(t *testing.T) {
	...
	process(context.Background(), j, enrichtest.NewFake(), nil, failingSender{}, "actor@keld.co", func() bool { return false }, emitter, nil, nil)
...
func TestWorkerEmitsJobQuarantinedOnExhaustion(t *testing.T) {
	...
	q := queue.New(10)
	fs := &fakeSender{}
	go Worker(context.Background(), q, bm, nil, fs, "t@keld.co", func() bool { return true }, func() bool { return true }, nil, emitter, nil)
