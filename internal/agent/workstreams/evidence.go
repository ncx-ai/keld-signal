...
// EvidenceFor summarises every block currently attributed to workstreamID.
...
func EvidenceFor(workstreamID string, blocks []AttributedBlock) Evidence {
	...
	for _, b := range blocks {
		if b.WorkstreamID != workstreamID {
			continue
		}
