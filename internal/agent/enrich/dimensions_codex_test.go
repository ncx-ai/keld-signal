...
func TestCodexIsDimensionEligible(t *testing.T) {
	if !DimensionsEligible("codex") {
...
func TestGeminiIsNotYetDimensionEligible(t *testing.T) {
	if DimensionsEligible("gemini_cli") || DimensionsEligible("gemini") {
