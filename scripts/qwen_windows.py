...
# clip and is_command_echo moved to app.analysis.text; re-exported so existing importers
# (scripts/context_value.py among them) keep working.
from app.analysis.text import clip, is_command_echo  # noqa: E402,F401
