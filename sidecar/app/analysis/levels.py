...
from app.analysis.paths import (
    PATH_INPUTS, WORKTREE, bash_refs, rel_within, resolve_workspace, scan_workspace)
from app.analysis.text import is_command_echo, text_of, think_blocks
from app.analysis.vocab import action_for, artifacts_for, mcp_provider, toolchain_for, vcs_of
