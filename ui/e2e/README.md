...
| `workstreams.spec.ts` | the coverage tile and ≥ 1 suggestion; "New workstream" and "Same as" each confirm **Applied on this machine** (the edit is local by contract); switching a group off changes its row and the "Groups on" tile |
